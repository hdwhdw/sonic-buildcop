...
- [ ] **ENRICH-01**: Collector fetches open bot PR (from mssonicbld) for each submodule in sonic-buildimage
- [ ] **ENRICH-02**: Collector fetches last merged bot PR for each submodule
- [ ] **ENRICH-03**: Collector fetches latest commit date from each submodule's own repo
